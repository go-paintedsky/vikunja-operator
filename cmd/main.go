...
import (
	...
	"github.com/go-paintedsky/vikunja-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(vikunjav1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "29af4395.paintedsky.io",
	...
	if err := (&controller.LabelReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "label")
		os.Exit(1)
	}
	if err := (&controller.VikunjaInstanceReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "vikunjainstance")
		os.Exit(1)
	}
