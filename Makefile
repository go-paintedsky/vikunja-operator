...
KIND_CLUSTER ?= vikunja-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name vikunja-operator-builder
	$(CONTAINER_TOOL) buildx use vikunja-operator-builder
	...
	- $(CONTAINER_TOOL) buildx rm vikunja-operator-builder
	rm Dockerfile.cross
